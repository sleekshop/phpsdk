...
private $post_data=array();
  ...
  */
 public function get_products_in_category($id_category=0,$lang=DEFAULT_LANGUAGE,$order_column="",$order="ASC",$left_limit=0,$right_limit=0,$needed_attributes=array(),$country=DEFAULT_COUNTRY)
 {
  $post_data=$this->post_data;
  ...
  * The Order determines the order
  */
 public function get_shopobjects_in_category($id_category=0,$lang=DEFAULT_LANGUAGE,$order_column="",$order="ASC",$left_limit=0,$right_limit=0,$needed_attributes=array(),$country=DEFAULT_COUNTRY)
 {
  $post_data=$this->post_data;
  ...
  */
 public function dump_category($id_category=0,$lang=DEFAULT_LANGUAGE,$order_column="",$order="ASC",$left_limit=0,$right_limit=0,$needed_attributes=array(),$country=DEFAULT_COUNTRY)
 {
  $post_data=$this->post_data;
 ...
 */
 public function get_product_details($id_product=0,$lang=DEFAULT_LANGUAGE,$country=DEFAULT_COUNTRY)
 {
  $post_data=$this->post_data;
 ...
 */
  ...
  * country determines the country from which you are adding the product. This is neccessary because of the tax - settings
  */
 public function add_to_cart($session="",$id_product=0,$quantity=0,$price_field="",$name_field="",$description_field="",$language=DEFAULT_LANGUAGE,$element_type="PRODUCT",$id_parent_element=0,$attributes=array(),$country="")
 {
  $post_data=$this->post_data;
...
*/
  ...
  */
 public function search_products($constraint=array(),$left_limit=0,$right_limit=0,$order_columns=array(),$order_type="ASC",$lang=DEFAULT_LANGUAGE,$needed_attributes=array(),$country=DEFAULT_COUNTRY)
  {
   $post_data=$this->post_data;
...
/*
  ...
  * The Order determines the order
  */
 public function seo_get_products_in_category($permalink="",$order_column="",$order="ASC",$left_limit=0,$right_limit=0,$needed_attributes=array(),$country=DEFAULT_COUNTRY)
 {
  $post_data=$this->post_data;
...
/*
  ...
  * The Order determines the order
  */
 public function seo_get_shopobjects_in_category($permalink="",$order_column="",$order="ASC",$left_limit=0,$right_limit=0,$needed_attributes=array(),$country=DEFAULT_COUNTRY)
 {
  $post_data=$this->post_data;
